...
$url64      = 'https://github.com/Ryujinx/release-channel-master/releases/download/1.1.1000/ryujinx-1.1.1000-win_x64.zip'
$checksum64 = 'aeef9ab7efebe6cfa33284956ed62aaa56ed7331353201828936052622a2f69e'
